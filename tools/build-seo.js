...
<!-- All 10 supported languages — same canonical for now (interactive site handles language) -->
<link rel="alternate" hreflang="en" href="${url}">
<link rel="alternate" hreflang="x-default" href="${url}">
<link rel="alternate" hreflang="fr" href="${SITE_URL}/?lang=fr#chapter-${idx}">
<link rel="alternate" hreflang="ar" href="${SITE_URL}/?lang=ar#chapter-${idx}">
<link rel="alternate" hreflang="es" href="${SITE_URL}/?lang=es#chapter-${idx}">
<link rel="alternate" hreflang="da" href="${SITE_URL}/?lang=da#chapter-${idx}">
<link rel="alternate" hreflang="de" href="${SITE_URL}/?lang=de#chapter-${idx}">
<link rel="alternate" hreflang="uk" href="${SITE_URL}/?lang=uk#chapter-${idx}">
<link rel="alternate" hreflang="pl" href="${SITE_URL}/?lang=pl#chapter-${idx}">
<link rel="alternate" hreflang="ur" href="${SITE_URL}/?lang=ur#chapter-${idx}">
<link rel="alternate" hreflang="fa" href="${SITE_URL}/?lang=fa#chapter-${idx}">
