...
const Timeline = (() => {
  const TIMELINE_DATA = {
    week1: {
      ...
      icon: '⚡',
      color: '#C60C30',
      desc: { en:'These are not optional. Do all of these in your first 7 days.', fr:'Ce n\'est pas facultatif. Faites tout cela dans vos 7 premiers jours.', ar:'هذه ليست اختيارية. قم بكل هذا في أول 7 أيام.', es:'No son opcionales. Haz todo esto en tus primeros 7 días.', da:'Disse er ikke valgfrie. Gør dem alle i dine første 7 dage.', de:'Diese Schritte sind nicht optional. Erledige alle in den ersten 7 Tagen.', uk:'Це не опціонально. Виконайте все протягом перших 7 днів.', pl:'To nie jest opcjonalne. Zrób to wszystko w pierwszych 7 dniach.', ur:'یہ اختیاری نہیں ہیں۔ پہلے 7 دنوں میں یہ سب کریں۔', fa:'اینها اختیاری نیستند. همه اینها را در ۷ روز اول انجام دهید.' },
      tasks: [
